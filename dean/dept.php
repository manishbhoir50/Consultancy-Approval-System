    ...
    <main>
        ...
        <div class="table-container mx-auto mt-5" id="table">
            ...
            <?php
                ...
                $result = load_details('pending', 'Dean', '', $Department, $start_date, $end_date);
            ...
            <?php
                ...
                $result = load_details('approved', 'Dean', '', $Department, $start_date, $end_date);
            ...
            <?php
                ...
                $result = load_details('completed', 'Dean', '', $Department, $start_date, $end_date);
            ...
            <?php
                ...
                $result = load_details('rejected', 'Dean', '', $Department, $start_date, $end_date);
            } else {
            ?>
                <script>
            ...
            <?php
                $_SESSION['status'] = "all";
                $result = load_details('all', 'Dean', '', $Department, $start_date, $end_date);
            }
            $is_date_clicked = false;
